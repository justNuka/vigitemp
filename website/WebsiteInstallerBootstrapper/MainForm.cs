...
public sealed class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        installDir = T(_s.InstallDir, placeholder: @"C:\ProgramData\VigiSensys\website"); serviceName = T(_s.ServiceName, placeholder: "VigitempWeb"); port = T(_s.Port, placeholder: "3000"); websiteBaseUrl = T(_s.WebsiteBaseUrl, placeholder: "http://127.0.0.1:3000/"); appBaseUrl = T(_s.AppBaseUrl, placeholder: "http://127.0.0.1:3000/");
