...
assert.match(mysqlTrigger, /NEW\.Derniere_Valeur\s*,\s*'CB'/)
assert.match(mysqlTrigger, /NEW\.Derniere_Valeur\s*,\s*'CH'/)
...
assert.match(mssqlTrigger, /@Derniere_Valeur\s*,\s*'CB'/)
assert.match(mssqlTrigger, /@Derniere_Valeur\s*,\s*'CH'/)
