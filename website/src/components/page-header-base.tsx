                  ...
                  {isOnAlarmsPage ? (
                      ...
                      <TooltipTrigger asChild>
                        <span>
                          <Button
                            variant="destructive"
                            size="sm"
                            className="min-w-[9rem] gap-2 px-3 md:min-w-[12rem] md:px-4 opacity-75 cursor-not-allowed"
                    ...
                    <Link href="alarmes">
                      <Button
                        variant="destructive"
                        size="sm"
                        className="min-w-[9rem] gap-2 px-3 md:min-w-[12rem] md:px-4 animate-pulse-subtle"
                        data-testid="button-active-alarms"
                      >
                        <AlertTriangle className="h-4 w-4" />
                        <span className="hidden sm:inline">
