...
type AlarmType = "high" | "low" | "no-response" | "sector" | "module" | "temperature";
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuCheckboxItem
          checked={typeFilters.includes("module")}
          onSelect={(e) => e.preventDefault()}
          onCheckedChange={(checked) => onToggleTypeFilter("module", checked === true)}
        >
          {t("filters.module")}
        </DropdownMenuCheckboxItem>
      </DropdownMenuContent>
