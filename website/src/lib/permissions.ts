...
const RULES: Record<AppPermission, PermissionRule> = {
  ...
  SURVEILLANCE_VIEW_ACCESS: {
    aliases: ["ACCES_SURVEILLANCE", "LIEU_VISUALISER", "ALARMES_GERER", "ACCES_DASHBOARD_UTILISATEUR", "ACCES_TABLEAU_BORD_UTILISATEUR", "ACCES_DASHBOARD_USER"],
  },
  DASHBOARD_ADMIN_ACCESS: {
    aliases: ["ACCES_DASHBOARD_ADMIN", "ACCES_TABLEAU_BORD_ADMIN", "ACCES_ADMIN"],
  },
  GENERAL_SETTINGS_ACCESS: {
    aliases: ["ACCES_PARAMETRAGE_GENERAL", "PARAMETRAGE_GENERAL", "GERER_PROFIL", "PARAMETRES_GERER", "ACCES_ADMIN"],
  },
  ALARM_ACK_ACCESS: {
    aliases: ["ACQUITTER_ALARME", "ACCES_ACQUITTEMENT_ALARME", "ALARMES_GERER"],
  },
  LOCATION_DISABLE_ACCESS: {
