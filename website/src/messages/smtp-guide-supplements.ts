  ...
  adminSettings: {
    ...
    smtp_guide: {
      ...
      google: {
        ...
        steps: "Activer la validation en deux étapes, créer un mot de passe d'application dans la sécurité du compte Google, puis utiliser l'adresse Gmail complète comme utilisateur et expéditeur. Enregistrer et lancer un email de test.",
      ...
      test_title: "Toujours terminer par un test",
      test_body: "Après enregistrement, envoyer un email de test. Une erreur 535 indique un refus d'authentification ; un timeout ou une erreur de connexion pointe plutôt vers le réseau, le port, le DNS ou TLS.",
      close: "Fermer",
    },
  },
}
  ...
  adminSettings: {
    ...
    smtp_guide: {
      ...
      google: {
        ...
        steps: "Enable 2-Step Verification, create an app password in Google Account security, then use the full Gmail address as username and sender. Save and send a test email.",
      ...
      test_title: "Always finish with a test",
      test_body: "After saving, send a test email. A 535 error means authentication was rejected; a timeout or connection error usually points to networking, port, DNS or TLS.",
      close: "Close",
    },
  },
}
