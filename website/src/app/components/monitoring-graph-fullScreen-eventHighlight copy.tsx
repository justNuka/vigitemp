...
export default function MonitoringGraphFullScreen_EventHighlightCopy(this: any, { idLieu, NomLieu, stateNeedReload, setStateNeedReload, _startDate, _endDate, eventHistory, setEventHistory } : {
    idLieu:number,
    NomLieu:string,
