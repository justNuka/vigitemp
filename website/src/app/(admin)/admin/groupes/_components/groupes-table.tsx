export function GroupesTable() {
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-sm">
        <thead className="border-b border-gray-200 dark:border-slate-700">
          <tr>
            <th className="text-left py-3 px-4 font-semibold">Nom Groupe</th>
            <th className="text-left py-3 px-4 font-semibold">Numéro Regroupement</th>
