...
export type AlarmRowType = 'high' | 'low' | 'no-response' | 'sector' | 'module' | 'ended'
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuCheckboxItem checked={typeFilters.includes('module')} onSelect={(e) => e.preventDefault()} onCheckedChange={(checked) => onToggleType('module', checked === true)}>
          {t('filters.module')}
        </DropdownMenuCheckboxItem>
