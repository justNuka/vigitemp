...
export const COPY: Record<"fr" | "en", TelephonyCopy> = {
  fr: {
    ...
    testCallTrialTemplate: "Compte Twilio Trial détecté : appel lancé avec le modèle TTS Twilio autorisé. Le message VigiSensys personnalisé sera validé après passage sur un compte complet.",
  ...
  en: {
    ...
    testCall: "Test call",
    testCallTrialTemplate: "Twilio Trial account detected: the call was placed using Twilio's allowed TTS template. The custom VigiSensys message will be validated after upgrading to a full account.",
