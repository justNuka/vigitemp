...
- État intégré courant : **Web 1.9.0**, **Serveur / installateur 1.1.0**, **BDD 0.91.1**, **Agent 1.0.1**.
...
- Le Web 1.9.0 ajoute un laboratoire UI de loaders et pages système derrière les pages de test : six animations métier, concepts 404/500/maintenance/réseau et mini diagnostic réseau, sans remplacer les chargements ni erreurs de production.
