...
Assert-Order $mysqlMigration "DROP TRIGGER IF EXISTS `TRG_GSO_BEF_UPD_LIEU_ALARME`" "SCHEMA_VERSION" "MySQL schema version must be updated after the trigger definition."
