...
Constat: DB host/credentials étaient hardcodés.
...
- `Vigitemp.Db.MeasureCacheDatabase` (optionnel : si `tm_graphique` est dans une autre DB)
...
- Mode `simulate` (optionnel, lié aux tests):
