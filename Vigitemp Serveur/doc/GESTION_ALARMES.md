...
### 1) Côté serveur C# (cœur du système)
...
Pas besoin d’aller en BDD à chaque mesure.
...
Sert à gérer le **retard d’alarme** et les **transitions**.

Optionnel mais recommandé : persister cet état en BDD pour survivre aux redémarrages.

---

### 3) Logique d’alarme (simplifiée)
...
### 4) Écritures en base (performant)
...
1 transaction, peu d’I/O, pas de triggers lourds.
...
- supporte bien des gros volumes de sondes
