...
INSERT INTO `t_parametre` (`Section`,`Mot_Cle`,`Valeur`,`Commentaire`) VALUES
  ('GENERAL','GLOBAL_LANGUAGE','fr','Langue globale de l\'application (mails et futurs modules)'),
  ('messaging','enabled','true','Active la messagerie interne'),
  ('NOTIFICATIONS','EMAIL_CC_RECIPIENTS','','Destinataires en copie sur tous les emails'),
  ('NOTIFICATIONS','EMAIL_SEND_ACK','1','Activer envoi email lors acquittement alarme'),
  ('NOTIFICATIONS','EMAIL_SEND_RESOLVED','1','Activer envoi email lors fin alarme'),
